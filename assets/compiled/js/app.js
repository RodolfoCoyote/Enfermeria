...
*/ (function () {
        ...
        "./node_modules/core-js/internals/array-from.js": function (a, f, r) {
          ...
          a.exports = function (w) {
            var _ = s(w),
              ...
              z;
            if (
              (j && (T = l(T, O > 2 ? arguments[2] : void 0, 2)),
              N != null && !(v == Array && h(N)))
            )
              for (z = N.call(_), L = new v(); !($ = z.next()).done; S++)
                g(L, S, j ? u(z, T, [$.value, S], !0) : $.value);
            else
              for (B = p(_.length), L = new v(B); B > S; S++)
                g(L, S, j ? T(_[S], S) : _[S]);
            return (L.length = S), L;
          };
        },
        ...
        "./node_modules/core-js/internals/classof.js": function (a, f, r) {
          ...
          a.exports = function (g) {
            ...
            return g === void 0
              ...
              : g === null
              ? "Null"
              : typeof (E = p((m = Object(g)), u)) == "string"
              ? E
              : h
              ? l(m)
              : (w = l(m)) == "Object" && typeof m.callee == "function"
              ? "Arguments"
              : w;
          };
        },
            ...
            if (
              (Dt &&
                ...
                O !== Object.prototype &&
                  ...
                  (!w &&
                    u(Ee) !== O &&
                    (h ? h(Ee, O) : typeof Ee[j] != "function" && g(Ee, j, L)),
                  p(Ee, gt, !0, !0),
                  w && (_[gt] = L))),
              Te == N &&
                _e &&
        ...
        "./node_modules/core-js/internals/global.js": function (a, f, r) {
          (function (l) {
            ...
            a.exports =
              u(typeof globalThis == s && globalThis) ||
              u(typeof window == s && window) ||
              u(typeof self == s && self) ||
              u(typeof l == s && l) ||
        ...
        "./node_modules/core-js/internals/iterators-core.js": function (
          ...
          [].keys &&
            ((v = [].keys()),
            "next" in v
              ? ((_ = l(l(v))), _ !== Object.prototype && (w = _))
              : (m = !0)),
            w == null && (w = {}),
            !p && !u(w, g) && s(w, g, E),
        ...
        "./node_modules/core-js/internals/object-create.js": function (
          ...
          (a.exports =
            ...
            function (T, j) {
              ...
              return (
                T !== null
                  ? ((_[w] = l(T)), (S = new _()), (_[w] = null), (S[E] = T))
                  : (S = v()),
                j === void 0 ? S : s(S, j)
              );
            }),
        ...
        "./node_modules/core-js/internals/redefine.js": function (a, f, r) {
          ...
          s("inspectSource", function (v) {
            ...
            (a.exports = function (v, O, T, j) {
              ...
              if (
                (typeof T == "function" &&
                  (typeof O == "string" && !h(T, "name") && u(T, "name", O),
        ...
        "./node_modules/core-js/internals/set-to-string-tag.js": function (
          ...
          a.exports = function (p, g, m) {
            p &&
              !s((p = m ? p : p.prototype), h) &&
              l(p, h, { configurable: !0, value: g });
          };
        },
        ...
        "./node_modules/core-js/internals/to-primitive.js": function (a, f, r) {
          ...
          a.exports = function (s, u) {
            ...
            if (
              (u &&
                typeof (h = s.toString) == "function" &&
                !l((p = h.call(s)))) ||
              (typeof (h = s.valueOf) == "function" && !l((p = h.call(s)))) ||
              (!u &&
                typeof (h = s.toString) == "function" &&
                !l((p = h.call(s))))
            )
    ...
    (function (a, f) {
      ...
      class $t extends vt {
        ...
        _initEvents() {
          this._supportPointerEvents
            ? (x.on(this._element, Br, (e) => this._start(e)),
              x.on(this._element, Fr, (e) => this._end(e)),
              this._element.classList.add(Ur))
            : (x.on(this._element, zr, (e) => this._start(e)),
        ...
        _eventIsPointerPenTouch(e) {
          return (
            this._supportPointerEvents &&
            (e.pointerType === Gr || e.pointerType === Yr)
          );
        }
        static isSupported() {
          return (
      ...
      class tt extends pe {
        ...
        _addEventListeners() {
          this._config.keyboard &&
            x.on(this._element, io, (e) => this._keydown(e)),
            this._config.pause === "hover" &&
              (x.on(this._element, ro, () => this.pause()),
      ...
      class it extends pe {
        ...
        _addAriaAndCollapsedClass(e, t) {
          if (e.length)
            for (const i of e)
              i.classList.toggle(Co, !t), i.setAttribute("aria-expanded", t);
        }
        static jQueryInterface(e) {
          const t = {};
          return (
      ...
      function Ne(n) {
        return (
          (Pe(n) ? n.ownerDocument : n.document) || window.document
        ).documentElement;
      }
      function zt(n) {
        return ve(n) === "html"
          ? n
          : n.assignedSlot || n.parentNode || (mn(n) ? n.host : null) || Ne(n);
      }
      function hi(n) {
      ...
      function Fo(n) {
        ...
        o != null &&
          ((typeof o == "string" &&
            ...
            (pi(e.elements.popper, o) && (e.elements.arrow = o)));
      }
      const gi = {
        name: "arrow",
        enabled: !0,
          ...
          if (
            (K === le(t) &&
              ...
              Ae(K).position !== "static" &&
                y === "absolute" &&
                ((U = "scrollHeight"), (q = "scrollWidth"))),
            (K = K),
            o === te || ((o === ne || o === oe) && c === ot))
          ) {
            V = re;
            var J =
              D && K === W && W.visualViewport ? W.visualViewport.height : K[U];
            (P -= J - i.height), (P *= b ? 1 : -1);
          }
          if (o === ne || ((o === te || o === re) && c === ot)) {
            Q = oe;
            var Z =
              D && K === W && W.visualViewport ? W.visualViewport.width : K[q];
            (C -= Z - i.width), (C *= b ? 1 : -1);
          }
        }
      ...
      function qo(n) {
        ...
        return (
          Ae(o || t).direction === "rtl" &&
            (y += Re(t.clientWidth, o ? o.clientWidth : 0) - c),
      ...
      function dt(n, e) {
        ...
        var t = e,
          ...
          V = n.elements[F ? X : R],
          W = ns(
            Pe(V) ? V : V.contextElement || Ne(n.elements.popper),
            b,
            A,
            d
          ),
        ...
        if (K) {
          if (c) {
            var ie,
              ...
              De = e.modifiersData["arrow#persistent"]
              ...
              Ue = wt(0, U[se], ht[se]),
              kn = Q
                ? U[se] / 2 - qt - Ue - Ct - Z.mainAxis
                : Hn - Ue - Ct - Z.mainAxis,
              sc = Q
                ? -U[se] / 2 + qt + Ue + tn + Z.mainAxis
                : Mt + Ue + tn + Z.mainAxis,
                  ...
                  if (Ci(X, Q)) {
                    (A.rects = {
                      ...
                      A.orderedModifiers.forEach(function (Z) {
                        return (A.modifiersData[Z.name] = Object.assign(
                          {},
                          Z.data
                        ));
                      });
                    for (var V = 0; V < A.orderedModifiers.length; V++) {
                      ...
                      typeof K == "function" &&
                        (A =
                          K({ state: A, options: q, name: J, instance: C }) ||
                          A);
                    }
                  }
                }
      ...
      class he extends pe {
        constructor(e, t) {
          super(e, t),
            ...
            (this._menu =
              I.next(this._element, Ft)[0] ||
              I.prev(this._element, Ft)[0] ||
              I.findOne(Ft, this._parent)),
        ...
        static dataApiKeydownHandler(e) {
          ...
          if ((!o && !i) || (t && !i)) return;
          e.preventDefault();
          const c = this.matches(He)
              ? this
              : I.prev(this, He)[0] ||
                I.next(this, He)[0] ||
                I.findOne(He, e.delegateTarget.parentNode),
      ...
      class ke extends pe {
        ...
        show(e) {
          this._isShown ||
            this._isTransitioning ||
            x.trigger(this._element, Gi, { relatedTarget: e })
              .defaultPrevented ||
            ((this._isShown = !0),
            (this._isTransitioning = !0),
        ...
        _showElement(e) {
          ...
          const i = () => {
            this._config.focus && this._focustrap.activate(),
              (this._isTransitioning = !1),
              x.trigger(this._element, pa, { relatedTarget: e });
          };
      ...
      class je extends pe {
        ...
        show(e) {
          if (
            this._isShown ||
            x.trigger(this._element, Ma, { relatedTarget: e }).defaultPrevented
          )
            return;
          (this._isShown = !0),
            this._backdrop.show(),
      ...
      const Va = new Set([
        ...
        Wa = (n, e) => {
          ...
          return e.includes(t)
            ? Va.has(t)
              ? !!(ka.test(n.nodeValue) || za.test(n.nodeValue))
              : !0
      ...
      class ze extends pe {
        ...
        hide() {
          if (
            ...
            return;
          if (
            (this._getTipElement().classList.remove(Ut),
            "ontouchstart" in document.documentElement)
          )
        ...
        _isAnimated() {
          return (
            ...
            (this.tip && this.tip.classList.contains(Ln))
          );
        }
        _isShown() {
            ...
            if (t === "click")
              ...
              x.on(this._element, i, this._config.selector, (c) => {
                ...
                x.on(this._element, o, this._config.selector, (c) => {
                  const d = this._initializeOnDelegatedTarget(c);
                  (d._activeTrigger[c.type === "focusout" ? Dn : Tt] =
      ...
      class Be extends pe {
        ...
        _keydown(e) {
          ...
          i &&
            (i.focus({ preventScroll: !0 }), Be.getOrCreateInstance(i).show());
        }
        _getChildren() {
      ...
      for (let r = 0; r < G.childElementCount; r++) {
        ...
        if (
          ...
          if (s.classList.contains("submenu-open")) {
            const u = ~~[...s.querySelectorAll(".submenu-link")].reduce(
              (h, p) => h + p.clientHeight,
              0
            );
            f += u;
          }
  ...
  class Or {
    ...
    toggleOverflowBody(k) {
      ...
      typeof k > "u"
        ? (f.style.overflowY = a ? "hidden" : "auto")
  ...
  const Bn = (G) => {
    if (!yt) return;
    Nt(window) &&
      (G.classList.add("inactive"), G.classList.add("sidebar-desktop"));
  ...
  document.readyState !== "loading"
    ? Bn(yt)
    : window.addEventListener("DOMContentLoaded", () => Bn(yt)),
